...
public final class IndexerWebOptions {
	public static final class Keys {
		...
		public static final String LOADS_HOST = "loads_host";
		public static final String LOADS_PORT = "loads_port";
	...
	public static final int DEFAULT_LOADS_PORT = 8087;
	...
	private final String loadsHost;
	private final int loadsPort;
	...
	private IndexerWebOptions(Builder builder) {
		...
		loadsHost = builder.loadsHost;
		loadsPort = builder.loadsPort;
	}
	...
	public static IndexerWebOptions from(JsonObject json) {
		...
		return builder()
			...
			.withLoadsHost(source.getString(Keys.LOADS_HOST, DEFAULT_UPSTREAM_HOST))
			.withLoadsPort(source.getInteger(Keys.LOADS_PORT, DEFAULT_LOADS_PORT))
			.build();
	}
	...
	public JsonObject toJson() {
		return new JsonObject()
			...
			.put(Keys.LOADS_HOST, loadsHost)
			.put(Keys.LOADS_PORT, loadsPort);
	}
	...
	public String loadsHost() {
		return loadsHost;
	}

	public int loadsPort() {
		return loadsPort;
	}
	...
	public static final class Builder {
		...
		private String loadsHost = DEFAULT_UPSTREAM_HOST;
		private int loadsPort = DEFAULT_LOADS_PORT;
		...
		public Builder withLoadsHost(String value) {
			loadsHost = value;
			return this;
		}

		public Builder withLoadsPort(int value) {
			loadsPort = value;
			return this;
		}
		...
		public IndexerWebOptions build() {
			...
			requireText(loadsHost, "loadsHost");
			validatePort(loadsPort, "loadsPort", false);
